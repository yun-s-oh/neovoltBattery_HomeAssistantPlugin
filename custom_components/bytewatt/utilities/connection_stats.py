...
class ConnectionStatistics:
    ...
    def get_status_report(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_response_time": (
                f"{self.avg_response_time:.2f}s" if self.avg_response_time else "N/A"
            ),
            "most_common_error": (
                self.most_common_error[0] if self.most_common_error else "None"
            ),
            ...
            "last_error": (
                self.last_error_time.isoformat() if self.last_error_time else "Never"
            ),
