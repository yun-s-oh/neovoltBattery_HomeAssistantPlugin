...
class DiagnosticService:
    ...
    def enable_diagnostics(self):
        ...
        self.log_diagnostic(
            "diagnostics_enabled", {"timestamp": datetime.now().isoformat()}
        )
    ...
    def disable_diagnostics(self):
        ...
        self.log_diagnostic(
            "diagnostics_disabled", {"timestamp": datetime.now().isoformat()}
        )
    ...
    async def run_health_check(self, coordinator) -> Dict[str, Any]:
        ...
        health_result["metrics"] = {
            ...
            "last_successful_update": (
                coordinator._last_successful_update.isoformat()
                if coordinator._last_successful_update
                else "never"
            ),
        }
        ...
        # Add overall status
        if (
            health_result["network_checks"].get("status") == "success"
